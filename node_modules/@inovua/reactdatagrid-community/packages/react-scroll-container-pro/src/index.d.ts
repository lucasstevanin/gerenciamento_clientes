...
declare const propTypes: {
    ...
    contain: PropTypes.Requireable<string | boolean>;
    ...
    scrollbars: PropTypes.Requireable<boolean | PropTypes.InferProps<{
    ...
    scrollThumbMargin: PropTypes.Requireable<string | number>;
    ...
    scrollThumbRadius: PropTypes.Requireable<string | number>;
    ...
    scrollThreshold: PropTypes.Requireable<string | number>;
};
