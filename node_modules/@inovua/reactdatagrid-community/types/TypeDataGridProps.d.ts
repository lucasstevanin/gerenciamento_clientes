...
import { TypeShowCellBorders, TypeRowProps, TypeLockedRow, TypeCollapsedGroups, TypeShowGroupSummaryRow, TypeBatchUpdateQueue, TypeCellProps, TypeGetColumnByParam, TypeExpandedRows, TypeCollapsedRows, TypeDetailsGridInfo, TypeExpandedNodes, TypeNodeCache, TypeNodeProps, TypeEditInfo, TypeDataSourceCache, TypeStickyRows, TypeFooterRow, TypePivotItem, TypePivotColumnSummaryReducer, TypeExpandedGroups, TypeGroupTool, CellProps } from '.';
...
export declare type TypeComputedProps = TypeDataGridPropsNoI18n & {
    ...
    startEdit?: ({ columnId, rowIndex, value, rowId, }: {
        columnId: string;
        rowIndex: number;
        value?: any;
        rowId?: string;
