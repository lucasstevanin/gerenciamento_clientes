...
export declare type TypeSummaryReducer<T = any> = {
    initialValue: T;
    name?: string;
...
export declare type TypeHeaderProps = {
    style?: CSSProperties;
    className?: string;
};
...
export declare type TypeColumn = TypeColWithNameProperty | TypeColWithIdProperty;
export declare type TypeColumnWithId = TypeColumn & {
    id: string;
};
export declare type TypeComputedColumn = TypeColumn & TypeColWithIdProperty & {
    id: string;
    pivotColumn?: boolean;
...
export declare type TypeColumns = TypeColumn[];
export declare type TypeColumnGroup = {
    name: string;
    header?: ReactNode;
    group?: string;
    computedDepth?: number;
};
export declare type TypeComputedColumnsMap = {
